  ...
  return (
    ...
    >
      ...
      <section id="conclusion">
        ...
        <KeyTakeaway>
          <strong>Next steps:</strong> Understand how to allocate your portfolio with <Link href="/articles/asset-allocation-101" className="text-soft-orange hover:underline">"Asset Allocation 101"</Link>. But first—<Link href="/articles/how-to-open-brokerage-account" className="text-soft-orange hover:underline">open that account</Link> and buy your first index fund this week.
        </KeyTakeaway>
      </section>
      ...
      <div className="bg-stone-50 border-l-4 border-soft-orange p-6 my-8">
        ...
        <p className="text-gray-700 mb-4">Ready to build your index fund portfolio? Read these next:</p>
        <ul className="space-y-3">
          ...
          <li>
            ...
            <span className="text-gray-600"> - How to split between stocks and bonds</span>
          </li>
          <li>
