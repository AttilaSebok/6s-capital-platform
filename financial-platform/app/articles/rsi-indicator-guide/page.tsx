    ...
    >
      ...
      <div className="bg-red-50 border-l-4 border-red-600 p-6 my-6">
        ...
        <ul className="space-y-4">
          <li>
            <strong>❌ Buying every time RSI hits 30:</strong> Oversold doesn&apos;t mean "buy now"especially in downtrends.
            <ul className="list-circle pl-6 mt-2">
              <li><strong>Solution:</strong> Only buy oversold RSI in confirmed uptrends (price above 50-MA and 200-MA).</li>
            </ul>
          </li>
          <li>
            <strong>❌ Selling every time RSI hits 70:</strong> In strong uptrends, RSI can stay overbought for weeks.
            <ul className="list-circle pl-6 mt-2">
              <li><strong>Solution:</strong> Use RSI &gt; 70 as a warning to tighten stops, not an automatic sell signal.</li>
            </ul>
          </li>
          <li>
            <strong>❌ Using RSI in isolation:</strong> RSI works best when combined with price action, support/resistance, and volume.
            <ul className="list-circle pl-6 mt-2">
              <li><strong>Solution:</strong> Confirm RSI signals with other indicators (moving averages, trendlines, chart patterns).</li>
            </ul>
          </li>
          <li>
            <strong>❌ Ignoring the trend:</strong> Counter-trend RSI trades (buying oversold in downtrends, selling overbought in uptrends) have low success rates.
            <ul className="list-circle pl-6 mt-2">
